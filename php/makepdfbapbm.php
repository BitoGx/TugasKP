...
else
{
  ...
  $sql="insert into repo_pbm(UserId,TransaksiPbmId,NamaDokumen,TanggalUnggah,TanggalTerakhirDiubah,TahunDibuat,FilePath) values ($iduser,$Id,'$docname','$date','$date',$year,'$file_path')";
