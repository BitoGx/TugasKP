			...
			<div class="app__inner">
				<div class="app__menu">
					<ul class="vMenu">
						...
						<li><a href="#" class="vMenu--active">Edit Supplier</a></li>
						<li><a href="penerima.php">Penerima</a></li>
					</ul>
				</div>
				<div class="app__main">
					<div class="text-container">
						<h3 class="app__main__title">Form Edit Supplier</h3>
						<p>Silahkan ubah informasi Supplier yang akan diubah</p>
            <form role='form' name='formedit' action='../php/editpenerima.php' method='post' onsubmit=''>
