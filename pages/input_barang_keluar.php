	...
	<div class="app">
		<div class="container">
            ...
            <li><a href="barang_keluar.php">Barang Keluar</a></li>
						<li><a href="#" class="vMenu--active">Input Barang Keluar</a></li>
					</ul>
				</div>
				<div class="app__main">
					<div class="text-container">
						<h3 class="app__main__title">Input Barang Keluar</h3>
						<p></p>
            <form role='form' name='formupload' action='../php/sim_barang_keluar.php' method='post' enctype='multipart/form-data' onsubmit='return FileCheck()'>
              <label>Tanggal</label>
              ...
              <input placeholder='Masukkan Tgl.Order' type='text' id='tgl_order' name='tgl_order' required>
