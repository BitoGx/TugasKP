			...
			<div class="app__inner">
				<div class="app__menu">
					<ul class="vMenu">
						...
						<li><a href="#" class="vMenu--active">Input Proses In</a></li>
            ...
            <li><a href="barang_keluar.php">Barang Keluar</a></li>
				...
				<div class="app__main">
					<div class="text-container">
						<h3 class="app__main__title">Input Proses In</h3>
						<p></p>
            <form role='form' name='formupload' action='../php/sim_proses_in.php' method='post' enctype='multipart/form-data' onsubmit='return FileCheck()'>
              ...
              <label>NIK</label>
              <input placeholder='NIK Pemberi' type='text' id='nama_pemberi' name='nama_pemberi' required>
              <label>Jabatan</label>
              <input placeholder='Jabatan Pemberi' type='text' id='nama_pemberi' name='nama_pemberi' required>
              <br>
              <label>Penerima</label>
              <!-- dropdown -->
              <input placeholder='Nama Penerima' type='text' id='nama_penerima' name='nama_penerima' required>
              <label>NIK</label>
