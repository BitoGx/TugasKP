...
<body>
	...
	<div class="app">
		<div class="container">
            ...
            <li><a href="#" class="vMenu--active">Proses Out</a></li>
            ...
            <li><a href="barang_keluar.php">Barang Keluar</a></li>
				...
				<div class="app__main">
					<div class="text-container">
						<h3 class="app__main__title">Proses Out</h3>
						<p></p>
            <a href="input_proses_out.php"><button type="button" name="uploadpdf" class="button button__accent">Tambah</button></a>
            <?php
              if(isset($_SESSION['Loggedin']))
              {
