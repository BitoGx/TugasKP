			...
			<div class="app__inner">
				<div class="app__menu">
					<ul class="vMenu">
						...
						<li><a href="#" class="vMenu--active">Edit Transaksi</a></li>
				...
				<div class="app__main">
					<div class="text-container">
						<h3 class="app__main__title">Form Edit Transaksi</h3>
						<p>Silahkan ubah informasi Transaksi yang akan diubah</p>
            <form role='form' name='formedit' action='../php/edittransaksi.php' method='post' onsubmit=''>
