                                        ...
                                        <div class="col-lg-6">
                                            <form role="form"  action="../php/upload.php" method="post" enctype="multipart/form-data">
                                                <div class="form-group">
                                                    ...
                                                    <p class="help-block">Masukan Judul PDF</p>
                                                </div>                                           
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <p class="help-block">Masukan Tahun </p>
                                                </div>  
                                                 <div class="form-group">
                                                ...
                                                <div>
                                                    <p>
                                                        ...
                                                        <a href="create.php" class="btn_a_style btn_blue">
                                                        <span class="glyphicon glyphicon-refresh">RESET</span></a>
                                                     </p>
                                                </div>
