			...
			<div class="app__inner">
				<div class="app__menu">
					<ul class="vMenu">
						...
						<li><a href="#" class="vMenu--active">Tambah Transaksi</a></li>
				...
				<div class="app__main">
					<div class="text-container">
						<h3 class="app__main__title">Form Tambah Transaksi</h3>
						<p>Silahkan isi informasi Transaksi yang akan ditambah</p>
            <form role="form" name="formtambah" action="../php/tambahtransaksi.php" method="post" onsubmit="">
