			...
			<div class="app__inner">
				<div class="app__menu">
					<ul class="vMenu">
						...
						<li><a href="#" class="vMenu--active">Transaksi</a></li>
				...
				<div class="app__main">
					<div class="text-container">
						<h3 class="app__main__title">Detail Transaksi</h3>
            <a href="formtambahtransaksi.php"><button type="button" name="tambahbarang" class="button button__accent">Tambah</button></a>
            <?php
