			...
			<div class="app__inner">
				<div class="app__menu">
					<ul class="vMenu">
						...
						<li><a href="#" class="vMenu--active">Edit Serah Terima</a></li>
				...
				<div class="app__main">
					<div class="text-container">
						<h3 class="app__main__title">Form Edit Serah Terima</h3>
						<p>Silahkan ubah informasi Serah Terima yang akan diubah</p>
            <form role='form' name='formedit' action='../php/edithpenyerahan.php' method='post' onsubmit=''>
              <label>Receiver ID</label>
              <select required>
                <option value='defautl'>Default</option>
                <option value='idreceiver'>Nama Receiver</option>
              </select>
